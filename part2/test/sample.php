...
class SampleTest extends PHPUnit_Framework_TestCase
{
  ...
  public function test入力値_昇順_OK ()
  {
    $okCaseArray = array(
      ...
      array(array("4", "a", 1, "b", "5"), array("a", "b", 1, 4, 5), '混在している配列'),
      array(array("もり", "ふくだ", "こやなぎ"), array("こやなぎ", "ふくだ", "もり"),
      '全角文字列'),
    );
  ...
  public function test入力値_降順_OK ()
  {
    $okCaseArray = array(
      ...
      array(array(), array(), '空の配列'),
      array(array("4", "a", 1, "b", "5"), array(5, 4, 1, "b", "a"), '混在している配列'),
      array(array("ふくだ", "もり", "こやなぎ"), array("もり", "ふくだ", "こやなぎ"),
      '全角文字列'),
    );
    foreach( $okCaseArray as $case ) {
      $msg = array_pop($case);
  ...
  public function test入力値_NG ()
  {
    $okCaseArray = array(
      ...
      array(array(true, false), '真偽値'),
      array(array(null), 'NULL'),
        array(array("a"=>1), '連想配列'),
        array(array(array()), '配列'),
        array());
  ...
  public function test結果_ソート済み数値のみ_降順()
  {
    $okCaseArray = array(
      ...
      array(array(20, 10, 8, 5, 2, 1), 'zero'),
